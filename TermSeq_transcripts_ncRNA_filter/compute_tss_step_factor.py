...
wig_matrix = WiggleMatrix(parsed_wiggles, chrom_sizes, processes=1).get_matrix_by_orientation()
f_wiggles_matrix, r_wiggles_matrix = wig_matrix.f_wiggle_matrix_df, wig_matrix.r_wiggle_matrix_df
